        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (heroSection) {
                const images = [
                    ...
                    'https://images.unsplash.com/photo-1500375592092-40eb2168fd21?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
                ...
                function changeBackgroundImage() {
                    ...
                    heroSection.style.backgroundImage = `linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('${images[currentImageIndex]}')`;
                }
                
                // Set initial background
                heroSection.style.backgroundImage = `linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('${images[0]}')`;
