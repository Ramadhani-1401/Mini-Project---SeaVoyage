...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'admin'])->group(function () {
    ...
    // Nahkoda Management Routes
    Route::resource('nahkodas', App\Http\Controllers\Admin\NahkodaController::class);
    ...
    Route::get('/reports/print-history', [ReportController::class, 'printHistory'])->name('reports.printHistory');
